            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item active">Список отмененных заказов</li>
                    </ol>
                </div>
            </div>
        </div><!-- /.container-fluid -->
    ...
    <section class="content">
        ...
        <div class="card">
            <div class="card-header">
                <h3 class="card-title">Список отмененных заказов</h3>
            </div>
            <div class="card-body">
                @if (count($canceled_orders))
                ...
                @else
                    <p>Отмененных заказов пока нет...</p>
                @endif
            </div>
            <!-- /.card-body -->
        </div>
