...
@section('content')
    ...
    <section class="content">
        ...
        <div class="card">
            ...
            <div class="card-body">
                <a href="{{ route('shop_orders.create') }}" class="btn btn-warning mb-3">Добавить заказ</a>
                @if (count($orders))
                        ...
                        <table class="display" id="post_table_index">
                            ...
                            @foreach($orders as $order)
                                <tr>
                                    ...
                                    <td>{{ $order->status }}</td>
                                    <td>
                                        <a href="{{ route('shop_orders.show', ['shop_order' => $order->id]) }}"
                                           class="btn btn-outline-secondary btn-sm float-left mr-1">
