...
@section('content')
    ...
    <section class="content">
        ...
        <div class="card">
            ...
            <div class="card-body">
                <a href="{{ route('shop_promocodes.create') }}" class="btn btn-primary mb-3">Добавить промокод</a>
                @if (count($promocodes))
                    <div class="table-responsive">
                        <table class="display" id="post_table_index">
                            ...
                            @foreach($promocodes as $promocode)
                                <tr @if(!$promocode->status) style="background-color: #ccc;" @endif>
                                    <td>{{ $promocode->id }}</td>
                                    ...
                                    <td>
                                        <a href="{{ route('shop_promocodes.edit', ['shop_promocode' => $promocode->id]) }}"
                                           class="btn btn-info btn-sm float-left mr-1">
                                            <i class="fas fa-pencil-alt"></i>
                                        </a>

                                        <form action="{{ route('shop_promocodes.destroy', ['shop_promocode' => $promocode->id]) }}"
