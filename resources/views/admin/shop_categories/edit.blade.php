            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item active">Редактирование категории магазина</li>
                    </ol>
                </div>
            </div>
        </div><!-- /.container-fluid -->
                ...
                <div class="col-8">
                    <div class="card">
                        ...
                        <form role="form" method="post"
                              action="{{ route('shop_categories.update', ['shop_category' => $category->id]) }}">
                            @csrf
                            @method('PUT')
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="section_id" id="section_id" class="select2"
                                        ...
                                        @foreach($sections as $k => $v)
                                            <option value="{{ $k }}" @if($k == $category->section_id) selected @endif>{{ $v }}</option>
                                        @endforeach
                                    </select>
                                </div>
